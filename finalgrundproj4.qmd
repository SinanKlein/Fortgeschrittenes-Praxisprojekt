...
institute: "Betreuerin: Dr. Sabine Hoffmann, Dr. Sally Olderbak"
format: 
  revealjs:
    css: customsty.css
    slide-number: true
...
::: {.text-center}
![](correlation_circle.png){width=90%}
:::
...
:::: { .column width="40%" }
<!-- Right column content -->
![](agetable2.png){width=60%} 
![](agetable1.png){width=70%} 
...
- **Distinct alcohol consumption profiles** can be robustly identified in the German population using **PCA-based clustering**
- A **four-cluster solution** captures meaningful differences in **consumption intensity, risk behavior, and severity**, supported by **silhouette and stability analyses**
- Clusters exhibit **systematic demographic and social differentiation**, driven primarily by **age**, and secondarily by **gender, income, education, and marital status**
- Applying **PCA before K-means** improves clustering reliability by reducing **dimensionality, correlation, and noise**
- The resulting typology provides a **data-driven foundation for targeted public health interventions and policy design**
