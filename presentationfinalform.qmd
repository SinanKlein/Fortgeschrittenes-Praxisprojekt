...
- [Distinct alcohol consumption profiles]{style="color:#006400; font-weight:bold;"} can be robustly identified in the dataset using [PCA-based clustering]{style="color:#006400; font-weight:bold;"}.
- A [four-cluster solution]{style="color:#006400; font-weight:bold;"} captures differences in [consumption intensity, risk behavior, and severity]{style="color:#006400; font-weight:bold;"}, supported by [silhouette and stability analyses]{style="color:#006400; font-weight:bold;"}.
- Clusters exhibit [demographic and social differentiation]{style="color:#006400; font-weight:bold;"}, driven primarily by [age]{style="color:#006400; font-weight:bold;"}, and secondarily by [gender, income, education, and marital status]{style="color:#006400; font-weight:bold;"}.
